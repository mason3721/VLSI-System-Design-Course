...
create_clock -name pwm_clk  -period 39.0  [get_ports pwm_clk]
...
set_ideal_network           [get_ports {cpu_clk axi_clk rom_clk dram_clk sram_clk pwm_clk}]
...
set_input_delay  -min 19.5 -clock pwm_clk [remove_from_collection [all_inputs] [get_ports {pwm_clk}]]
set_output_delay -max 19.5 -clock pwm_clk [all_outputs]
set_output_delay -min 19.5 -clock pwm_clk [all_outputs]
